...
repositories=(go-service go-http-middleware go-jsonrpc)
revisions=(
...
replace github.com/faustbrian/go-service => $temporary/go-service
replace github.com/faustbrian/go-http-middleware => $temporary/go-http-middleware
replace github.com/faustbrian/go-jsonrpc => $temporary/go-jsonrpc
EOF
